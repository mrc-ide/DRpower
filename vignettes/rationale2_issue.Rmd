...
The type of data that we will work with is shown below. This is a very simple dataset consisting of a numerator and denominator for each cluster. The cluster-level prevalence is calculated as one over the other, expressed as a percentage.
...
This example is even simpler than most real world datasets, as here the number of people tested is identical over all clusters when it reality it often varies. So why is this a tricky dataset to analyse? How can we possibly get our analysis wrong here!?
