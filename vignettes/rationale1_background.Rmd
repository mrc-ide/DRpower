...
The majority of malaria diagnosis worldwide relies on rapid diagnostic tests (RDTs). A large proportion of these tests work by detecting the presence of the HPR2 protein in the blood of an infected individual, which reacts to give a positive result. However, *Plasmodium* parasites have been found around the world that carry a deletion of the *pfhrp2* gene. No *pfhrp2* gene means no HPR2 protein, rendering these parasites invisible to testing by HRP2-based RDTs. This can present a major clinical problem if these gene deletions are at high prevalence in the population, as patients presenting with signs of malaria may be misdiagnosed, resulting in treatment delays and poor health outcomes.

## 2. What does DRpower do?

For the purposes of DRpower, we assume that our aim is to design a survey to estimate the prevalence of *pfhrp2/3* deletions within a given region. More specifically, our aim is to determine whether the prevalence of deletions is above a given threshold (a 5% threshold is used by default, although this can be changed).
